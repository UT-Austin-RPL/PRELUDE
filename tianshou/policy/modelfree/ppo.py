    ...
    def learn(  # type: ignore
        ...
        for step in range(repeat):
            ...
            for b in batch.split(batch_size, merge_last=True):
                ...
                actor_means.append(actor_mean.item())
                actor_stds.append(actor_std.item())
        ...
        return {
            ...
            "loss/Clipped Loss": clip_losses,
            "loss/Value Loss": vf_losses,
            "loss/Entropy Loss": ent_losses,
            "loss/Surrogate Loss": surr_losses,
            "actor/Gaussian Mean": actor_means,
            "actor/Gaussian Std": actor_stds,
        }
